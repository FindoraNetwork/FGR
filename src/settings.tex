\documentclass[12pt,notitlepage,a4paper,print]{article}
...
\newpagestyle{main}[\small\bfseries]{
    \sethead
    [][\href{http://www.gov.cn/}{\color{gray} \tiny \texttt{}}][] % 偶数页
    {}{\href{http://www.gov.cn/}{\color{gray} \tiny \texttt{Wherever the sun and the moon shine, wherever the river arrives, it is Han.}}}{} % 奇数页
    \headrule % 页眉画线
    \setfoot
...
\lstdefinestyle{base}{
    ...
    gobble=2, % 缩进字符数量
    %
    basicstyle=\footnotesize\color{black}\fontspec{Monaco},
